...
public class GameScreen extends ScreenAdapter {
    ...
    static final float WORLD_HEIGHT = 15 * 20;    //20画面登れば終了
    ...
    public void render(float delta){
        ...
        if (mPlayer.getY() > mCamera.position.y) {
            ...
            Gdx.app.log("JampActionGame", "mCamera.position.y:"+mCamera.position.y);
        }
